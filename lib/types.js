define(function() {
	///
	// Defines user-defined types and utility functions used by bdParse.

	function mix(dest) {
		for(var src, p, i = 1; i<arguments.length; i++){
			src = arguments[i];
