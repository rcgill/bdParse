define(["./types"], function(types){
	...
	function VarNode(
		...
		this.semicolonToken = semicolonToken;
		set(this, arguments, sumLocations(varToken, semicolonToken || types.back(varDefs)));
	}
	...
	function FunctionLiteralNode(
		...
		FunctionDefNode.call(this, functionToken, nameToken, leftParenToken, parameterList, rightParenToken, leftBrace, body, rightBrace);
	}
	...
	result.replaceNode = function(oldNode, newNode){
